...
var PlayState = {
    ...
    //set location or all the assets and adding all the physics for sprites
    create: function() {
        ...
        var healthText = this.game.add.text(10, 20, `${action[2].name.slice(0, 6)}: `, {
            fontSize: '20px',
            fill: '#ffffff'
        })
        ...
        var healthText1 = this.game.add.text(335, 20, `${action[1].name.slice(0, 6)}: `, {
            fontSize: '20px',
            fill: '#ffffff'
        })
        ...
        var healthText2 = this.game.add.text(660, 20, `${action[3].name.slice(0, 6)}: `, {
            fontSize: '20px',
            fill: '#ffffff'
        })
        ...
        var healthText3 = this.game.add.text(980, 20, `${action[4].name.slice(0, 6)}: `, {
            fontSize: '20px',
            fill: '#ffffff'
        })
    ...
    restartTextClick: function() {
        ...
        newGameText.events.onInputDown.add(function() {
            window.location.href = "http://localhost:8080/newgame";
        }, this);
    },
