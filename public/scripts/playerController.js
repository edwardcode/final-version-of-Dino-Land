...
function create() {
    ...
    buttonB.events.onInputOver.add(function() {
        punch = true;
    });
    buttonB.events.onInputOut.add(function() {
        punch = false;
    });
    buttonB.events.onInputDown.add(function() {
        punch = true;
    });
    buttonB.events.onInputUp.add(function() {
        punch = false;
    });
    ...
    buttonA.events.onInputOver.add(function() {
        fire = true;
    });
    buttonA.events.onInputOut.add(function() {
        fire = false;
    });
    buttonA.events.onInputDown.add(function() {
        fire = true;
    });
    buttonA.events.onInputUp.add(function() {
        fire = false;
    });
    // Add the VirtualGamepad plugin to the game
    this.gamepad = this.game.plugins.add(Phaser.Plugin.VirtualGamepad);
    // Add a joystick to the game (the button comes with joytick has been disabled)
